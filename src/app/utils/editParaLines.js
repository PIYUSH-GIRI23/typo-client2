const editParaLines = (type, paraLines, punctuation = false, numbers = false, symbols = false, noPeriod = false) => {
    if (type !== 'para' || !Array.isArray(paraLines) || (!punctuation && !numbers && !symbols && !noPeriod)) 
        return paraLines;
